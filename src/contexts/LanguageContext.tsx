...
const translations = {
  ...
  hi: {
    ...
    'home.hero.subtitle': 'भारत में विजया केवल एक पौधा नहीं है — यह एक संस्कार है। संस्कृति, चेतना और देखभाल का प्रतीक।',
    ...
    'home.research.text': 'विजया की उपचारात्मक और सांस्कृतिक क्षमता को उजागर करने के लिए कठोर अध्ययन आगे बढ़ाना।',
    'home.education.title': 'शिक्षा और कानूनी सुधार',
    'home.education.text': 'कलंक और पुराने बाधाओं को दूर करने के लिए जागरूकता और नीति ढांचे का निर्माण।',
    'home.cultural.title': 'सांस्कृतिक पुनर्जागरण',
    'home.cultural.text': 'पवित्र परंपराओं को पुनर्जीवित करना और विजया के आसपास भारत की पहचान को मजबूत करना।',
    ...
    'about.intro': 'विश्व विजया फाउंडेशन (वीवीएफ) भारत की विजया को वैश्विक मंच पर लाने के लिए समर्पित एक गैर-लाभकारी पहल है।',
    ...
    'waitlist.benefits': 'विश्व विजया फाउंडेशन प्रतीक्षा सूची में शामिल होकर, आप करेंगे:',
    ...
    'waitlist.form.subtitle': 'आंदोलन में अपनी जगह सुरक्षित करने के लिए नीचे अपना विवरण दर्ज करें।',
